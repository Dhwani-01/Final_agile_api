...
const auth = new google.auth.OAuth2({
  clientId: '482592331817-9r52hnqq28fi90mj2dn3v1ajd6t1okrv.apps.googleusercontent.com',
  clientSecret: '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',
  redirectUri: 'http://localhost:3000',
});

auth.setCredentials({
  access_token: 'ya29.a0AfB_byCPWHGc2Vwmss2jJapBVZZMu-oBt7lY2_cAs5OIT8wTD3lgwFbAoKTPj53S_uXY7XWnDHHOFSiElUUsB6kDcyDJl8uwvDsmAN8HKSmnRNXo1D05JEPHEER2fbYSUGsLiVZ-cfho2PBDE6iYhNfapSeiW6U8ss1yaCgYKAWoSARESFQGOcNnCDBJ0pOsHFFsMk_ZcuelISQ0171',
});
...
async function createMeetingLink() {
  try {
    ...
    const event = {
      ...
      description: 'Meeting Description',
      start: {
        dateTime: '2023-10-12T06:00:00',
        timeZone: 'Asia/Kolkata',
      },
      end: {
        dateTime: '2023-10-12T7:00:00',
        timeZone: 'Asia/Kolkata',
      },
      conferenceData: {
        createRequest: {
...
const mailConfigurations = { 
  ...
  from: 'godhadhwani@gmail.com', 
    
  // Comma Separated list of mails 
  to: 'baharjainbj23@gmail.com, cartoonmania2003@gmail.com, deepikamandroniya2002@gmail.com', 
